package com.azki.insurance.domain.application.input;

import com.azki.insurance.common.app.config.SearchCommonConfigData;
import com.azki.insurance.domain.application.api.input.QueryHandler;
