package com.azki.insurance.presentation.reservation.service.presentation.controller.api;

import com.azki.insurance.presentation.domain.api.command.CommandResult;
import com.azki.insurance.presentation.domain.api.input.CommandHandler;
import com.azki.insurance.presentation.reservation.service.presentation.api.data.security.AuthenticationEdgeRequestDTO;
import com.azki.insurance.presentation.reservation.service.presentation.api.data.security.AuthenticationEdgeResponseDTO;
import com.azki.insurance.presentation.reservation.service.presentation.api.data.security.CreateUserEdgeRequestDTO;
import com.azki.insurance.presentation.reservation.service.presentation.api.data.security.CreateUserEdgeResponseDTO;
import com.azki.insurance.presentation.reservation.service.domain.api.command.CreateUserCommand;
import com.azki.insurance.presentation.reservation.service.domain.api.command.LoginCommand;
